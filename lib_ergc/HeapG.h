...
template <class T, typename U>
 ...
 public:
  ...
  /**
   * Creates a new <code>HeapG</code> with the specified size.
   * @param n	the maximum size of the heap.
   */
 HeapG( int n ): _size(n), _nitem(0),_data(0) {
  ...
  /**
   * Removes and returns the next element with the maximum key value.
